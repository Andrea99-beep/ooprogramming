...
public class PongPanel extends JPanel implements ActionListener, KeyListener {
	...
	public void init() {
		...
		hgo = new HashMap<String, GameObject>();
	...
	public void keyPressed(KeyEvent e) {
		...
		if (e.getKeyCode() == KeyEvent.VK_UP) hgo.get("player_dx").setSpeedY(-4);
		if (e.getKeyCode() == KeyEvent.VK_DOWN) hgo.get("player_dx").setSpeedY(4);
	...
	public void keyReleased(KeyEvent e) {
		...
		if (e.getKeyCode() == KeyEvent.VK_DOWN) hgo.get("player_dx").setSpeedY(0);
