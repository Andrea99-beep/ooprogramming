...
public class FileProcessor {
	...
	public static void main(String[] args) {
		...
		/*
		 * if (!(new File(src)).exists()) { System.out.println("src does not exist!");
		 * System.exit(0); }
		 * 
		 * if ((new File(dst)).exists()) {
		 * System.out.println("dst does exist! Overwrite? "); Scanner scr = new
		 * Scanner(System.in); String reply = scr.nextLine(); if (reply.equals("n"))
		 * System.exit(0); }
		 */
